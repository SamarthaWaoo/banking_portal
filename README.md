...
On Render, create a New Web Service → connect your GitHub repo.
Set:
...
Deploy. Render auto-builds on every push to your main branch.
...
Credit score ≥ 650
Debt-to-Income ratio (expenses + existing EMI + new EMI ÷ income) ≤ 45%
New EMI ≤ 60% of disposable income (salary − expenses)
